...
class View301: UIViewController {
    ...
    var player1Score = 301
    var player2Score = 301
    var player3Score = 301
    var player4Score = 301
    var player5Score = 301
    var player6Score = 301
    var turnsTaken = 0
    var currentHighScore = HighScoreData.fetchGame(in: Store.sharedMainContext(), game: "301")
