...
class View701: UIViewController {
    ...
    var player1Score = 701
    var player2Score = 701
    var player3Score = 701
    var player4Score = 701
    var player5Score = 701
    var player6Score = 701
    var turnsTaken = 0
    var currentHighScore = HighScoreData.fetchGame(in: Store.sharedMainContext(), game: "701")
